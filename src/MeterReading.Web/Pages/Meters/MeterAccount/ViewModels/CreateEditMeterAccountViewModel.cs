...
namespace MeterReading.Web.Pages.Meters.MeterAccount.ViewModels
{
    public class CreateEditMeterAccountViewModel
    {
        ...
        [Display(Name = "MeterAccountSort1")]
        public string Sort1 { get; set; }

        [Display(Name = "MeterAccountSort2")]
        public string Sort2 { get; set; }

        [Display(Name = "MeterAccountSort3")]
        public string Sort3 { get; set; }

        [Display(Name = "MeterAccountSort4")]
        public string Sort4 { get; set; }

        [Display(Name = "MeterAccountSort5")]
