...
{
    public partial class AddedMeterAccount : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Sort1 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Sort2 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Sort3 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Sort4 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Sort5 = table.Column<string>(type: "nvarchar(max)", nullable: true),
